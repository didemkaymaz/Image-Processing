...
# gercek zamanli olarak tespit etmek icin 'cv2.VideoCapture (0)' kullanilmistir
...
df= pd.DataFrame(ds)
df.to_csv('smile_records_webcam.csv')

df = pd.read_csv('C:\\Users\\DK\\PycharmProjects\\GoruntuIslemeProje\\meter\\smile_records_webcam.csv')

fig = px.line(df, x = 'times', y = 'smile_ratio', title='Smile Records Webcam')
